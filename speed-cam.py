                ...
                if (abs(end_pos_x - prev_pos_x) >= MO_MIN_X_DIFF_PX and
                    ...
                    if track_count >= MO_TRACK_EVENT_COUNT:
                        ...
                        if ave_speed > MO_MAX_SPEED_OVER or CALIBRATE_ON:
                            ...
                            if IM_SHOW_TEXT_ON:
                                medida = 0
                                if 320 >= end_pos_x > 260:
                                    medida = 0
                                elif 260 >= end_pos_x > 250:
                                    medida = 1.00
                                elif 250 >= end_pos_x > 240:
                                    medida = 1.25
                                elif 240 >= end_pos_x > 230:
                                    medida = 1.50
                                elif 230 >= end_pos_x > 220:
                                    medida = 1.75
                                elif 220 >= end_pos_x > 210:
                                    medida = 2.00
                                elif 210 >= end_pos_x > 200:
                                    medida = 2.25
                                elif 200 >= end_pos_x > 190:
                                    medida = 2.50
                                elif 190 >= end_pos_x > 180:
                                    medida = 2.75
                                elif 180 >= end_pos_x > 170:
                                    medida = 3.00
                                elif 170 >= end_pos_x > 165:
                                    medida = 3.25
                                elif 165 >= end_pos_x > 160:
                                    medida = 3.50
                                elif 160 >= end_pos_x > 155:
                                    medida = 3.75
                                elif 155 >= end_pos_x > 150:
                                    medida = 4.00
                                elif 150 >= end_pos_x > 143:
                                    medida = 4.25
                                elif 143 >= end_pos_x > 135:
                                    medida = 4.50
                                elif 135 >= end_pos_x > 127:
                                    medida = 4.75
                                elif 127 >= end_pos_x > 120:
                                    medida = 5.00
                                elif 120 >= end_pos_x > 110:
                                    medida = 5.50
                                elif 110 >= end_pos_x > 100:
                                    medida = 6.00
                                elif 100 >= end_pos_x > 90:
                                    medida = 6.50
                                elif 90 >= end_pos_x > 80:
                                    medida = 7.00
                                elif 80 >= end_pos_x > 70:
                                    medida = 7.50
                                elif 70 >= end_pos_x > 60:
                                    medida = 8.00
                                elif 60 >= end_pos_x > 50:
                                    medida = 8.50
                                elif 50 >= end_pos_x > 40:
                                    medida = 9.00
                                elif 40 >= end_pos_x > 30:
                                    medida = 10.00
